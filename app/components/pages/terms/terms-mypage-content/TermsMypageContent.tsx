import * as styles from '@components/pages/terms/terms-mypage-content/TermsMypageContent.style';
import Check from '@assets/icons/common/TermsCheckBox.svg';
import MarginTop from '@components/common/MarginTop';

const TermsMypageContent = () => {
  return (
    <styles.Box>
      ...
      <styles.ContentContainer>
        <styles.TitleContainer>
          ...
          <styles.TitleBox>
            <styles.Title>정보 알림 수신 동의</styles.Title>
          </styles.TitleBox>
        </styles.TitleContainer>
        <MarginTop height={9} />
        <styles.ContentBox>
...
export default TermsMypageContent;
